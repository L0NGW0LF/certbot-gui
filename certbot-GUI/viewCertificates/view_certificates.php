...
// Per debug, stampiamo l'output grezzo di certbot
// echo "<pre>$output</pre>";
                    ...
                    <?php foreach ($certificates as $cert): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="operation/download.php?cert_path=<?php echo urlencode($cert['cert_path']); ?>&key_path=<?php echo urlencode($cert['key_path']); ?>">Scarica</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
